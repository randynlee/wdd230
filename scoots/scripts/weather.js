...
const apiUrl = `https://api.openweathermap.org/data/2.5/weather?units=imperial&q=Cozumel,mx&appid=${apiKey}`;
const url = `https://api.openweathermap.org/data/2.5/weather?units=imperial&lat=20.48&lon=-86.93&appid=${apiKey}`;
const url1 = `https://api.openweathermap.org/data/2.5/forecast?units=imperial&lat=20.48&lon=-86.93&appid=${apiKey}`;
...
const currentHumidity = document.querySelector("#fig5");
