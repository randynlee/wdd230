...
const apiUrl = `https://api.openweathermap.org/data/2.5/weather?units=imperial&q=Ivins,us&appid=${apiKey}`;
const url = `https://api.openweathermap.org/data/2.5/weather?units=imperial&lat=37.16&lon=-113.67&appid=${apiKey}`;
const url1 = `https://api.openweathermap.org/data/2.5/forecast?units=imperial&lat=37.16&lon=-113.67&appid=${apiKey}`;
